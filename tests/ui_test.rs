...
fn test_activities_relative_performance_column() {
    ...
    assert!(
        content.contains("RelPerf"),
        "Should have Relative Performance column"
    );
...
fn test_dashboard_shows_stats() {
    ...
    assert!(
        content.contains("Biggest Distance"),
        "Should contain Biggest Distance widget"
    );
    assert!(
        content.contains("Best Pace"),
        "Should contain Best Pace widget"
    );
    assert!(
        content.contains("Activities this month"),
        "Should contain Activities this month widget"
    );
}
